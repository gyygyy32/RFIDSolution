...
namespace RFIDMain
{
    ...
    {
        private UHFReader.ReaderMethod reader;
        ...
        {
            //初始化访问读写器实例
            reader = new UHFReader.ReaderMethod();//UHFReader.ReaderMethod();
        ...
        private void rdbRS232_CheckedChanged(object sender, EventArgs e)
        {
            if (rdbRS232.Checked)
            {
                ...
                btnDisconnectRs232.Enabled = true;//modify by genhong.hu On 2018-01-04
        ...
        private void ProcessFastSwitch(UHFReader.MessageTran msgTran)
        {
