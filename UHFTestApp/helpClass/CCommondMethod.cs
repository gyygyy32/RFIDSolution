...
namespace Helper
{
    class CCommondMethod
    {
        ...
        //public static byte[] ConvertStringToByteArray(string asciiString)
        //{
        //    byte[] btAryHex = new byte[asciiString.Length];

        //    int i = 0;
        //    foreach (char c in asciiString)
        //    {
        //        int tmp = c;
        //        string hex = String.Format("{0:x2}", (uint)System.Convert.ToUInt32(tmp.ToString()));

        //        btAryHex[i++] = Convert.ToByte(hex, 16);
        //    }
        //    return hex.TrimEnd();
        //}
