...
namespace UHFReader
{
    public class PR9200Msg
    {
        ...
        public PR9200Msg(byte btReadId, byte btCmd, byte[] btAryData)
        {
         ...
         */
        public PR9200Msg(byte btReadId, byte btCmd)
        {
            this.btPacketType = 0xA0;
            this.btDataLen = 0x03;
            this.btReadId = btReadId;
         ...
         */
        public PR9200Msg(byte[] btAryTranData)
        {
